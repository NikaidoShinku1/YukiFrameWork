...
namespace YukiFrameWork
{
    ...
    public interface IGetEntityManager : IGetArchitecture
    {
    ...
    public static class CommandCenterExtension
    {
        ...
        public static async UniTask<bool> Send_AsyncCommand<T>(this IGetCommandCenter CommandCenter, T command, IObjectContainer container = null, object data = null) where T : ICommand
            => await CommandCenter.GetArchitecture().CommandCenter.Send_AsyncCommand<T>(command, container, data);

        public static async UniTask<bool> Send_AsyncCommand<T>(this IGetCommandCenter CommandCenter, IObjectContainer container = null, object data = null) where T : ICommand,new()
    ...
    {
        public static IEntityManager GetEntityManager(this IGetEntityManager manager)
            => manager.GetArchitecture().EntityManager;
    }
