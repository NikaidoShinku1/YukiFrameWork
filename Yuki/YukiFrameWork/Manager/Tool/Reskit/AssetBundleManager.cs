...
namespace YukiFrameWork.Res
{
    public class AssetBundleManager 
    {
        ...
        public  AssetBundleRequest LoadFromAsyncAssetBundle<T>(string assetBundleName, string assetName) where T :Object
        {if (!IsInit) Init();
        ...
        /// <param name="assetBundleName">包名</param>
        /// <returns>返回一个AssetBundleRequest</returns>
        public  AssetBundleRequest LoadFromAsyncAllAssetBundle<T>(string assetBundleName) where T : Object
        {
            if (!IsInit) Init();
            Check(assetBundleName);
        ...
        public  T GetFromAssetBundle<T>(string assetBundleName, string assetName) where T : Object
        {
            if (!IsInit) Init();
        ...
        /// <returns></returns>
        public  List<T> GetFromAllAssetBundle<T>(string assetBundleName) where T : Object
        {
            if (!IsInit) Init();
        ...
        /// <returns></returns>
        private  T CheckAsset<T>(string assetBundleName, string assetName = null) where T : Object
        {
            Check(assetBundleName);
        ...
        /// <param name="assetBundleName"></param>
        /// <returns></returns>
        private  List<T> CheckAllAsset<T>(string assetBundleName) where T : Object
        {
            Check(assetBundleName);
        ...
        private  void Check(string assetBundleName)
        {
            if (!loadedAssetBundles.ContainsKey(assetBundleName))
            {
        ...
        /// <param name="assetBundleName"></param>
        /// <returns></returns>
        private  List<T> LoadAllAsset<T>(string assetBundleName) where T : Object
        {
            if (!loadedAssetBundles.ContainsKey(assetBundleName))
            {
                Debug.LogError("Do Not Get Key!");
        ...
        /// 释放包
        /// </summary>
        public  void UnLoadBundle(string assetBundleName,bool isUnLoad = false)
        {
            if (!loadedAssetBundles.ContainsKey(assetBundleName))
            {
        ...
        public void UnLoadAllBundle(bool isUnload = false,System.Action CallBack = null)
        {
