...
namespace YukiFrameWork.Res
{
    ...
    {
        public List<AsyncCallBack<List<Object>>> asyncCallBacks { get; private set; } = ListPools<AsyncCallBack<List<Object>>>.Get();
    ...
    {
        public List<AsyncCallBack<Object>> asyncCallBacks { get; set; } = ListPools<AsyncCallBack<Object>>.Get();
