...
public class AssetBundleManager : Singleton<AssetBundleManager>
{
    ...
    protected Dictionary<uint, ResourcesItem> resourcesItemDic = DictionaryPools<uint, ResourcesItem>.Get();

    //储存已经加载的ab包，根据crc来判定
    protected Dictionary<uint, AssetBundleItem> assetBundleItemDic = DictionaryPools<uint, AssetBundleItem>.Get();
