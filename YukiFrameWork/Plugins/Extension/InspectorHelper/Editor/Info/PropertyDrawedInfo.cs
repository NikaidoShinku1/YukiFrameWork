...
namespace YukiFrameWork
{
    ...
    public abstract class PropertyDrawedInfo
    {
...
#else
                Property.displayName.Substring(1)
#endif
                : Label.Label;          
        ...
        public bool CheckPropertyInGeneric()
        {
        ...
        public virtual bool OnDefaultDisableGroup()
        {           
            if(DisableGroupIf == null && DisableGroupEnumValueIf == null) return false;
            var obj = GlobalReflectionSystem.GetValue(target.GetType(), target, DisableGroupIf?.ValueName);
            var enumValue = GlobalReflectionSystem.GetValue(target.GetType(), target, DisableGroupEnumValueIf?.Name);
            if (obj == null && enumValue == null) return false;
            ...
            if (enumValue != null)
            {
                if (enumValue.ToString() == DisableGroupEnumValueIf.Enum.ToString())
                {
                    return true;
                }
            }          
        ...
        public virtual bool DrawConditionIf(Type type,Object target)
        {
            ...
            if ((DisableEnumValueIf != null && DisableEnumValueIf.Length > 0) || (DisableIf != null && DisableIf.Length > 0))
            {
                ...
                if (DisableEnumValueIf.Length > 0)
                {
                    ...
                    {
                        object e = GlobalReflectionSystem.GetValue(target.GetType(), target, DisableEnumValueIf[i].Name);
