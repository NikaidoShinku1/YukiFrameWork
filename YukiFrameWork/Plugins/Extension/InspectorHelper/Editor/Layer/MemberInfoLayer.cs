...
namespace YukiFrameWork
{
    public class MemberInfoLayer : GenericLayer
    {
        class InfoData
        {
            ...
            public List<PropertyDrawedInfo> PropertyDrawedInfos = new List<PropertyDrawedInfo>();
        ...
        {       
            ...
            {              
                ...
                if (setting != null)
                {
                    ...
                    if (label == null) label = new LabelAttribute(char.ToUpper(member.Name[0])
                        +
                ...
                if ((CheckPropertyInGeneric(itemType) || setting != null) && listDrawerSetting != null)
                {
        ...
        public override void OnInspectorGUI()
        {
            foreach (var info in infoDatas)
            {
                ...
                {              
                    ...
                    EditorGUI.BeginDisabledGroup(OnDisableGroup(member,CheckPropertyInGeneric(member.ItemType)));
                    Property(member);
