...
namespace YukiFrameWork.Extension
{
    ...
    public class ViewControllerDataInfo
    {
        ...
        public static string PrefabGenerationPath => !IsEN ? "Prefab 生成路径:" : "Prefab Generate Path:";

        public static string DescriptionInfo => !IsEN ? "将文件夹拖入这个区间" : "Drag the folder into this interval";

        public static string CreatePrefabInfo => !IsEN ? "创建Prefab" : "Create Prefab";

        public static string Update_PrefabInfo => !IsEN ? "更新Prefab" : "Update Prefab";
