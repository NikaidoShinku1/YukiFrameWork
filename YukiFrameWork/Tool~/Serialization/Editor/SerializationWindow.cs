...
namespace YukiFrameWork.Extension
{
    public class SerializationWindow : EditorWindow
    {
        ...
        [MenuItem("YukiFrameWork/序列化工具",false,100)]
        ...
        private void DrawSerializableInfo()
        {
            ...
            {
                string text = AssetDatabase.LoadAssetAtPath<TextAsset>(ImportSettingWindow.importPath).text;
                ImportSettingWindow.Data data = AssemblyHelper.DeserializeObject<ImportSettingWindow.Data>(text);
                UnityEngine.Object excel = AssetDatabase.LoadAssetAtPath<UnityEngine.Object>(data.path + "/Serialization/ExcelToJson/excel2json.exe");
