///=====================================================
/// - FileName:      StateFloatConditionInspector.cs
/// - NameSpace:     YukiFrameWork.Machine
/// - Description:   高级定制脚本生成
/// - Creation Time: 2025/3/13 14:16:01
...
namespace YukiFrameWork.Machine
{
    public class StateFloatConditionInspector : StateConditionInspector
    {
        ...
        {
            base.OnGUI(rect, condition, runtimeStateMachineCore);
