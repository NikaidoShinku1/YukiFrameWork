...
|--|--|
|void Init(FolderType folderType = FolderType.persistentDataPath, string saveFolderName = "SaveData")|存档工具的初始化方法|
|void Init(string saveCustomDirName, string saveFolderName = "SaveData")|自定义初始化路径|
...
SaveTool可以通过左上角菜单YukiFrameWork/SaveTool查看对应选择文件夹类型的路径