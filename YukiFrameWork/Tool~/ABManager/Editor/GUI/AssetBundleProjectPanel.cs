...
{
    public class AssetBundleProjectPanel  : ScriptableObject
    {
        ...
        [SerializeField]
        public List<ABProject> dependenceProjects;        // 依赖的项目
        ...
        public static AssetBundleProjectPanel CreatePanel(EditorWindow window)  
        {
            AssetBundleProjectPanel panel = CreateInstance<AssetBundleProjectPanel>();
        ...
        public static AssetBundleProjectPanel CreatePanel(EditorWindow window,ABProject project)  
        {
            AssetBundleProjectPanel panel = CreateInstance<AssetBundleProjectPanel>();
        ...
        private void InitProjects()
        {
            ...
            dependenceProjects = new List<ABProject>();
        ...
        // 初始化 Project 
        private void InitProjectToThis(ABProject project) {

            name = project.name;
            displayName = project.displayName;
            //outputPath = project.out_path;
            //panel.dependenceProjects = new List<ABProject>();

            for (int i = 0; i < project.dependenceProject.Count; i++)
            {
                ABProject ABProject = ABProjectManager.Instance.GetProject(project.dependenceProject[i]);
                if (ABProject != null)
                {
                    dependenceProjects.Add(ABProject);
                }
            }
        ...
        private void VerifyProjectName()
        {
            ...
            if (project == null)
            {
                ...
                if (ABProjectManager.Instance.IsContainProject(name))
                {
