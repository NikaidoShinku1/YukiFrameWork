...
namespace YukiFrameWork.ABManager
{
    ...
    public class AssetBundleManagerCreate : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            if (bundlePanel == null)
            {
                bundlePanel = AssetBundleProjectPanel.CreatePanel(this);
            }
        ...
        private void CreateProject() {
            ...
            //ABProject project1 = bundlePanel.CreateProject();
            if (bundlePanel.IsAllVerifyPass())
            {
                ...
                if (path != null)
                {
                    ...
                    Debug.Log(path);
                    ABProject project = CreateInstance<ABProject>();
